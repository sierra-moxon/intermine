      ...
      <p class="more">
        ...
        <div id="low">
            ...
            <div id="api">
                ...
                <ul id="api-langs">
                <!--<ul>-->
                    <a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=perl">Perl</a>&nbsp;&nbsp;
                    <a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=python">Python</a>&nbsp;&nbsp;
                    <a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=ruby">Ruby   </a>&nbsp;&nbsp;
                    <a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=java">Java</a>&nbsp;&nbsp;
                </ul> 
            </div>
