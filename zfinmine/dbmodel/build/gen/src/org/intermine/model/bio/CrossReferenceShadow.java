...
public class CrossReferenceShadow implements CrossReference, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.CrossReference.linkType
    ...
    @Override public String toString() { return "CrossReference [id=\"" + id + "\", identifier=\"" + identifier + "\", linkType=\"" + linkType + "\", source=" + (source == null ? "null" : (source.getId() == null ? "no id" : source.getId().toString())) + ", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + "]"; }
