...
public interface SequenceFeature extends org.intermine.model.bio.BioEntity
{
    ...
    public java.util.Set<org.intermine.model.bio.SequenceAlteration> getPresentIn();
    public void setPresentIn(final java.util.Set<org.intermine.model.bio.SequenceAlteration> presentIn);
    public void addPresentIn(final org.intermine.model.bio.SequenceAlteration arg);

    public java.util.Set<org.intermine.model.bio.Lab> getLabOfOrigin();
    public void setLabOfOrigin(final java.util.Set<org.intermine.model.bio.Lab> labOfOrigin);
    public void addLabOfOrigin(final org.intermine.model.bio.Lab arg);

    public java.util.Set<org.intermine.model.bio.SequenceAlteration> getMissingFrom();
    public void setMissingFrom(final java.util.Set<org.intermine.model.bio.SequenceAlteration> missingFrom);
    public void addMissingFrom(final org.intermine.model.bio.SequenceAlteration arg);

    public java.util.Set<org.intermine.model.bio.SequenceAlteration> getMovedIn();
    public void setMovedIn(final java.util.Set<org.intermine.model.bio.SequenceAlteration> movedIn);
    public void addMovedIn(final org.intermine.model.bio.SequenceAlteration arg);
