...
public class MarkerShadow implements Marker, ShadowClass
{
    public static final Class<Marker> shadowOf = Marker.class;
    ...
    protected java.util.Set<org.intermine.model.bio.MarkerRelationship> marker1s = new java.util.HashSet<org.intermine.model.bio.MarkerRelationship>();
    ...
    protected java.util.Set<org.intermine.model.bio.MarkerRelationship> marker2s = new java.util.HashSet<org.intermine.model.bio.MarkerRelationship>();
    ...
    protected java.util.Set<org.intermine.model.bio.FeatureMarkerRelationship> relatedFeatures = new java.util.HashSet<org.intermine.model.bio.FeatureMarkerRelationship>();
    ...
    @Override public boolean equals(Object o) { return (o instanceof Marker && id != null) ? id.equals(((Marker)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Marker [comments=\"" + comments + "\", id=\"" + id + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", symbol=\"" + symbol + "\", type=\"" + type + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MarkerShadow.class.equals(getClass())) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        marker1s = new ProxyCollection<org.intermine.model.bio.MarkerRelationship>(os, this, "marker1s", org.intermine.model.bio.MarkerRelationship.class);
        marker2s = new ProxyCollection<org.intermine.model.bio.MarkerRelationship>(os, this, "marker2s", org.intermine.model.bio.MarkerRelationship.class);
        relatedFeatures = new ProxyCollection<org.intermine.model.bio.FeatureMarkerRelationship>(os, this, "relatedFeatures", org.intermine.model.bio.FeatureMarkerRelationship.class);
    }
