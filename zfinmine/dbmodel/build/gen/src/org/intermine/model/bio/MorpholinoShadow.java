...
public class MorpholinoShadow implements Morpholino, ShadowClass
{
    public static final Class<Morpholino> shadowOf = Morpholino.class;
    ...
    protected java.util.Set<org.intermine.model.bio.EnvironmentalCondition> environmentalConditions = new java.util.HashSet<org.intermine.model.bio.EnvironmentalCondition>();
    ...
    protected java.util.Set<org.intermine.model.bio.Gene> targets = new java.util.HashSet<org.intermine.model.bio.Gene>();
    ...
    @Override public boolean equals(Object o) { return (o instanceof Morpholino && id != null) ? id.equals(((Morpholino)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Morpholino [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", comments=\"" + comments + "\", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", score=\"" + score + "\", scoreType=\"" + scoreType + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=\"" + symbol + "\", type=\"" + type + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MorpholinoShadow.class.equals(getClass())) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        environmentalConditions = new ProxyCollection<org.intermine.model.bio.EnvironmentalCondition>(os, this, "environmentalConditions", org.intermine.model.bio.EnvironmentalCondition.class);
        targets = new ProxyCollection<org.intermine.model.bio.Gene>(os, this, "targets", org.intermine.model.bio.Gene.class);
