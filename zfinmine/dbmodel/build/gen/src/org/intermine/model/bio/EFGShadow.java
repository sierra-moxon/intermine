...
public class EFGShadow implements EFG, ShadowClass
{
    public static final Class<EFG> shadowOf = EFG.class;
    ...
    // Col: org.intermine.model.bio.EFG.crossReferences
    ...
    // Col: org.intermine.model.bio.EFG.promotes
    ...
    @Override public boolean equals(Object o) { return (o instanceof EFG && id != null) ? id.equals(((EFG)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "EFG [comments=\"" + comments + "\", id=\"" + id + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", symbol=\"" + symbol + "\", type=\"" + type + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.EFGShadow.class.equals(getClass())) {
