...
public class GenotypeEnvironmentShadow implements GenotypeEnvironment, ShadowClass
{
    public static final Class<GenotypeEnvironment> shadowOf = GenotypeEnvironment.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof GenotypeEnvironment && id != null) ? id.equals(((GenotypeEnvironment)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "GenotypeEnvironment [environment=" + (environment == null ? "null" : (environment.getId() == null ? "no id" : environment.getId().toString())) + ", genotype=" + (genotype == null ? "null" : (genotype.getId() == null ? "no id" : genotype.getId().toString())) + ", id=\"" + id + "\", primaryIdentifier=\"" + primaryIdentifier + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.GenotypeEnvironmentShadow.class.equals(getClass())) {
