...
public class FeatureMarkerRelationshipShadow implements FeatureMarkerRelationship, ShadowClass
{
    public static final Class<FeatureMarkerRelationship> shadowOf = FeatureMarkerRelationship.class;
    ...
    public org.intermine.model.bio.SequenceAlteration getFeature() { if (feature instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.SequenceAlteration) ((org.intermine.objectstore.proxy.ProxyReference) feature).getObject()); }; return (org.intermine.model.bio.SequenceAlteration) feature; }
    public void setFeature(final org.intermine.model.bio.SequenceAlteration feature) { this.feature = feature; }
    ...
    @Override public boolean equals(Object o) { return (o instanceof FeatureMarkerRelationship && id != null) ? id.equals(((FeatureMarkerRelationship)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "FeatureMarkerRelationship [feature=" + (feature == null ? "null" : (feature.getId() == null ? "no id" : feature.getId().toString())) + ", id=\"" + id + "\", marker=" + (marker == null ? "null" : (marker.getId() == null ? "no id" : marker.getId().toString())) + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", relationshipType=\"" + relationshipType + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.FeatureMarkerRelationshipShadow.class.equals(getClass())) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) &&"rfeature".equals(notXml[i])) {
                i++;
                feature = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.SequenceAlteration.class);
                i++;
            };
