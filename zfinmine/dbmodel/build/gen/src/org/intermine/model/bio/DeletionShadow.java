...
public class DeletionShadow implements Deletion, ShadowClass
{
    public static final Class<Deletion> shadowOf = Deletion.class;
    // Ref: org.intermine.model.bio.Deletion.chromosomalDeletion
    protected org.intermine.model.InterMineObject chromosomalDeletion;
    public org.intermine.model.bio.ChromosomalDeletion getChromosomalDeletion() { if (chromosomalDeletion instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.ChromosomalDeletion) ((org.intermine.objectstore.proxy.ProxyReference) chromosomalDeletion).getObject()); }; return (org.intermine.model.bio.ChromosomalDeletion) chromosomalDeletion; }
    public void setChromosomalDeletion(final org.intermine.model.bio.ChromosomalDeletion chromosomalDeletion) { this.chromosomalDeletion = chromosomalDeletion; }
    public void proxyChromosomalDeletion(final org.intermine.objectstore.proxy.ProxyReference chromosomalDeletion) { this.chromosomalDeletion = chromosomalDeletion; }
    public org.intermine.model.InterMineObject proxGetChromosomalDeletion() { return chromosomalDeletion; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.Deletion.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("chromosomalDeletion".equals(fieldName)) {
            chromosomalDeletion = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("chromosomalDeletion".equals(fieldName)) {
            return org.intermine.model.bio.ChromosomalDeletion.class;
        }
        if ("type".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.Deletion.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Deletion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.DeletionShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Deletion");
        if (chromosomalDeletion != null) {
            sb.append("$_^rchromosomalDeletion$_^").append(chromosomalDeletion.getId());
        }
        if (type != null) {
            sb.append("$_^atype$_^");
            String string = type;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.DeletionShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Deletion)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rchromosomalDeletion".equals(notXml[i])) {
                i++;
                chromosomalDeletion = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.ChromosomalDeletion.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Deletion.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Deletion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
