...
public class ZFATermShadow implements ZFATerm, ShadowClass
{
    ...
    @Override public boolean equals(Object o) { return (o instanceof ZFATerm && id != null) ? id.equals(((ZFATerm)o).getId()) : this == o; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.ZFATerm.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ZFATerm.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ZFATerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ZFATermShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ZFATerm");
        if (identifier != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ZFATermShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ZFATerm)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ZFATerm.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ZFATerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
