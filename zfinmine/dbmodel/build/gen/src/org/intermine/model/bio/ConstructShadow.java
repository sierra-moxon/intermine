...
public class ConstructShadow implements Construct, ShadowClass
{
    public static final Class<Construct> shadowOf = Construct.class;
    ...
    protected java.util.Set<org.intermine.model.bio.Gene> CDS = new java.util.HashSet<org.intermine.model.bio.Gene>();
    ...
    protected java.util.Set<org.intermine.model.bio.Gene> Promoter = new java.util.HashSet<org.intermine.model.bio.Gene>();
    ...
    protected java.util.Set<org.intermine.model.bio.Gene> codingSequences = new java.util.HashSet<org.intermine.model.bio.Gene>();
    ...
    protected java.util.Set<org.intermine.model.bio.Region> contains = new java.util.HashSet<org.intermine.model.bio.Region>();
    ...
    protected java.util.Set<org.intermine.model.bio.Gene> promoters = new java.util.HashSet<org.intermine.model.bio.Gene>();
    ...
    // Col: org.intermine.model.bio.Construct.crossReferences
    ...
    protected java.util.Set<org.intermine.model.bio.TransgenicInsertion> phenotypicAlleles = new java.util.HashSet<org.intermine.model.bio.TransgenicInsertion>();
    public java.util.Set<org.intermine.model.bio.TransgenicInsertion> getPhenotypicAlleles() { return phenotypicAlleles; }
    public void setPhenotypicAlleles(final java.util.Set<org.intermine.model.bio.TransgenicInsertion> phenotypicAlleles) { this.phenotypicAlleles = phenotypicAlleles; }
    public void addPhenotypicAlleles(final org.intermine.model.bio.TransgenicInsertion arg) { phenotypicAlleles.add(arg); }

    // Col: org.intermine.model.bio.Construct.innocuousAlleles
    protected java.util.Set<org.intermine.model.bio.TransgenicInsertion> innocuousAlleles = new java.util.HashSet<org.intermine.model.bio.TransgenicInsertion>();
    public java.util.Set<org.intermine.model.bio.TransgenicInsertion> getInnocuousAlleles() { return innocuousAlleles; }
    public void setInnocuousAlleles(final java.util.Set<org.intermine.model.bio.TransgenicInsertion> innocuousAlleles) { this.innocuousAlleles = innocuousAlleles; }
    public void addInnocuousAlleles(final org.intermine.model.bio.TransgenicInsertion arg) { innocuousAlleles.add(arg); }

    // Col: org.intermine.model.bio.Construct.insertionAlleles
    protected java.util.Set<org.intermine.model.bio.TransgenicInsertion> insertionAlleles = new java.util.HashSet<org.intermine.model.bio.TransgenicInsertion>();
    public java.util.Set<org.intermine.model.bio.TransgenicInsertion> getInsertionAlleles() { return insertionAlleles; }
    public void setInsertionAlleles(final java.util.Set<org.intermine.model.bio.TransgenicInsertion> insertionAlleles) { this.insertionAlleles = insertionAlleles; }
    public void addInsertionAlleles(final org.intermine.model.bio.TransgenicInsertion arg) { insertionAlleles.add(arg); }
    ...
    @Override public boolean equals(Object o) { return (o instanceof Construct && id != null) ? id.equals(((Construct)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Construct [id=\"" + id + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", symbol=\"" + symbol + "\", type=\"" + type + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ConstructShadow.class.equals(getClass())) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        CDS = new ProxyCollection<org.intermine.model.bio.Gene>(os, this, "CDS", org.intermine.model.bio.Gene.class);
        Promoter = new ProxyCollection<org.intermine.model.bio.Gene>(os, this, "Promoter", org.intermine.model.bio.Gene.class);
        ...
        codingSequences = new ProxyCollection<org.intermine.model.bio.Gene>(os, this, "codingSequences", org.intermine.model.bio.Gene.class);
        contains = new ProxyCollection<org.intermine.model.bio.Region>(os, this, "contains", org.intermine.model.bio.Region.class);
        promoters = new ProxyCollection<org.intermine.model.bio.Gene>(os, this, "promoters", org.intermine.model.bio.Gene.class);
        ...
        phenotypicAlleles = new ProxyCollection<org.intermine.model.bio.TransgenicInsertion>(os, this, "phenotypicAlleles", org.intermine.model.bio.TransgenicInsertion.class);
        innocuousAlleles = new ProxyCollection<org.intermine.model.bio.TransgenicInsertion>(os, this, "innocuousAlleles", org.intermine.model.bio.TransgenicInsertion.class);
        insertionAlleles = new ProxyCollection<org.intermine.model.bio.TransgenicInsertion>(os, this, "insertionAlleles", org.intermine.model.bio.TransgenicInsertion.class);
    }
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("CDS".equals(fieldName)) {
            ...
            phenotypicAlleles.add((org.intermine.model.bio.TransgenicInsertion) element);
        } else if ("innocuousAlleles".equals(fieldName)) {
            innocuousAlleles.add((org.intermine.model.bio.TransgenicInsertion) element);
        } else if ("insertionAlleles".equals(fieldName)) {
            insertionAlleles.add((org.intermine.model.bio.TransgenicInsertion) element);
        } else {
            if (!org.intermine.model.bio.Construct.class.equals(getClass())) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("phenotypicAlleles".equals(fieldName)) {
            return org.intermine.model.bio.TransgenicInsertion.class;
        }
        if ("innocuousAlleles".equals(fieldName)) {
            return org.intermine.model.bio.TransgenicInsertion.class;
        }
