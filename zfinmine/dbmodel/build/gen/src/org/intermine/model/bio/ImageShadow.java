...
public class ImageShadow implements Image, ShadowClass
{
    public static final Class<Image> shadowOf = Image.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof Image && id != null) ? id.equals(((Image)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Image [figure=" + (figure == null ? "null" : (figure.getId() == null ? "no id" : figure.getId().toString())) + ", id=\"" + id + "\", imageFileName=\"" + imageFileName + "\", imageUrl=\"" + imageUrl + "\", primaryIdentifier=\"" + primaryIdentifier + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ImageShadow.class.equals(getClass())) {
