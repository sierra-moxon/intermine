...
public class EnvironmentShadow implements Environment, ShadowClass
{
    public static final Class<Environment> shadowOf = Environment.class;
    ...
    protected java.util.Set<org.intermine.model.bio.EnvironmentalCondition> conditions = new java.util.HashSet<org.intermine.model.bio.EnvironmentalCondition>();
    ...
    protected java.util.Set<org.intermine.model.bio.GenotypeEnvironment> genotypeEnvironments = new java.util.HashSet<org.intermine.model.bio.GenotypeEnvironment>();
    ...
    @Override public boolean equals(Object o) { return (o instanceof Environment && id != null) ? id.equals(((Environment)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Environment [id=\"" + id + "\", name=\"" + name + "\", primaryIdentifier=\"" + primaryIdentifier + "\", publication=" + (publication == null ? "null" : (publication.getId() == null ? "no id" : publication.getId().toString())) + "]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.EnvironmentShadow.class.equals(getClass())) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        conditions = new ProxyCollection<org.intermine.model.bio.EnvironmentalCondition>(os, this, "conditions", org.intermine.model.bio.EnvironmentalCondition.class);
        genotypeEnvironments = new ProxyCollection<org.intermine.model.bio.GenotypeEnvironment>(os, this, "genotypeEnvironments", org.intermine.model.bio.GenotypeEnvironment.class);
    }
