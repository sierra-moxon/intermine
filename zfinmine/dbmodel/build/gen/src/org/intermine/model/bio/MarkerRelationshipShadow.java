...
public class MarkerRelationshipShadow implements MarkerRelationship, ShadowClass
{
    public static final Class<MarkerRelationship> shadowOf = MarkerRelationship.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof MarkerRelationship && id != null) ? id.equals(((MarkerRelationship)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "MarkerRelationship [id=\"" + id + "\", marker1=" + (marker1 == null ? "null" : (marker1.getId() == null ? "no id" : marker1.getId().toString())) + ", marker2=" + (marker2 == null ? "null" : (marker2.getId() == null ? "no id" : marker2.getId().toString())) + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", type=\"" + type + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MarkerRelationshipShadow.class.equals(getClass())) {
