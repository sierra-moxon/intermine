...
public class TranscriptShadow implements Transcript, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Transcript.type
    protected java.lang.String type;
    public java.lang.String getType() { return type; }
    public void setType(final java.lang.String type) { this.type = type; }

    // Attr: org.intermine.model.bio.Transcript.comments
    ...
    // Ref: org.intermine.model.bio.Transcript.pseudogene
    ...
    // Col: org.intermine.model.bio.Transcript.promotes
    ...
    @Override public String toString() { return "Transcript [VegaId=\"" + VegaId + "\", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", comments=\"" + comments + "\", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", protein=" + (protein == null ? "null" : (protein.getId() == null ? "no id" : protein.getId().toString())) + ", pseudogene=" + (pseudogene == null ? "null" : (pseudogene.getId() == null ? "no id" : pseudogene.getId().toString())) + ", score=\"" + score + "\", scoreType=\"" + scoreType + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", status=\"" + status + "\", symbol=\"" + symbol + "\", type=\"" + type + "\", typeDefinition=\"" + typeDefinition + "\", typeStatusDefinition=\"" + typeStatusDefinition + "\"]"; }
