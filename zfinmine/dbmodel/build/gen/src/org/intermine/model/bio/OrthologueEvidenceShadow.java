...
public class OrthologueEvidenceShadow implements OrthologueEvidence, ShadowClass
{
    ...
    @Override public String toString() { return "OrthologueEvidence [evidenceCode=" + (evidenceCode == null ? "null" : (evidenceCode.getId() == null ? "no id" : evidenceCode.getId().toString())) + ", id=\"" + id + "\", primaryIdentifier=\"" + primaryIdentifier + "\"]"; }
