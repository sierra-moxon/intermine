...
public class ChromosomalDeletionShadow implements ChromosomalDeletion, ShadowClass
{
    ...
    // Col: org.intermine.model.bio.ChromosomalDeletion.deletions
    protected java.util.Set<org.intermine.model.bio.Deletion> deletions = new java.util.HashSet<org.intermine.model.bio.Deletion>();
    public java.util.Set<org.intermine.model.bio.Deletion> getDeletions() { return deletions; }
    public void setDeletions(final java.util.Set<org.intermine.model.bio.Deletion> deletions) { this.deletions = deletions; }
    public void addDeletions(final org.intermine.model.bio.Deletion arg) { deletions.add(arg); }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        deletions = new ProxyCollection<org.intermine.model.bio.Deletion>(os, this, "deletions", org.intermine.model.bio.Deletion.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("deletions".equals(fieldName)) {
            deletions.add((org.intermine.model.bio.Deletion) element);
        } else if ("markersMissing".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("deletions".equals(fieldName)) {
            return org.intermine.model.bio.Deletion.class;
        }
        if ("markersMissing".equals(fieldName)) {
