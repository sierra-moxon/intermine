 ...
 * @author
 */
public class DataSourceSupplierConverter extends BioFileConverter
{
    //
    private static final String DATASET_TITLE = "Data Suppliers";
    private static final String DATA_SOURCE_NAME = "ZFIN";

    private static final Logger LOG = Logger.getLogger(DataSourceSupplierConverter.class);
     ...
     */
    public DataSourceSupplierConverter(ItemWriter writer, Model model) {
